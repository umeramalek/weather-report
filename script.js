// call upon the search button variable
var searchButton = $(".searchButton");

// get the api key
var apiKey = "b8ecb570e32c2e5042581abd004b71bb";

// Forloop - local storage
...
// call on the search button
searchButton.click(function () {

    // call on the search input from html
    var searchInput = $(".searchInput").val();

    // url Variable for current weather
    var urlCurrent = "https://api.openweathermap.org/data/2.5/weather?q=" + searchInput + "&Appid=" + apiKey + "&units=imperial";
    // url Variable for 5 day forecast
    ...
    if (searchInput == "") {
        ...
        $.ajax({
            ...
            // update according to current date 
        ...
        $.ajax({
            ...
            var fiveDayDiv = $(".fiveDayForecast").addClass("card-text");
            fiveDayDiv.empty();
            // For each for 5 days
